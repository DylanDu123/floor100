...
Person.prototype = {
    ...
    initSprite: function() { //初始化精灵
        ...
        sprite.add("down", new Tool.sprite.Animation({
            startX: 64,
            sw: 64,
            sh: 64,
            width: 32,
        ...
        sprite.add("normal", new Tool.sprite.Animation({
            sw: 64,
            sh: 64,
            width: 32,
            height: 32
        }));
        sprite.add("up", new Tool.sprite.Animation({
            startX: 128,
            sw: 64,
            sh: 64,
            width: 32,
        ...
        sprite.add("right", new Tool.sprite.Animation({
            startX: 320,
            fs: 2,
            sw: 64,
            sh: 64,
        ...
        sprite.add("left", new Tool.sprite.Animation({
            startX: 192,
            fs: 2,
            sw: 64,
            sh: 64,
    ...
    changeDir: function(dir, flag) { //改变方向
        ...
        if (dir == "left") this.sprite.setXSpeed(this.xspeed * -1);
        else if (dir == "right") this.sprite.setXSpeed(this.xspeed);
        else if (dir == "normal" && !flag) this.sprite.setXSpeed(0);
        else if (dir == "up") this.sprite.setYSpeed( this.yspeed *-2, 0.4);
